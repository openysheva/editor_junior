...
/*
    ...
    Почему-то оказалось, что им удобнее читать их по-нарастающему количеству символов в комментарии.
    Ваша задача отсортировать исходную выгрузку, которую вам принес аналитик.
